    ...
    >
      ...
      <div className='flex justify-between items-center mt-8 lg:mt-16 flex-col lg:flex-row'>
          ...
          <form className='w-full space-y-3 lg:space-y-5'>
            ...
            >
              ...
              <div className='flex items-center gap-x-2 lg:gap-x-5'>
                {[BiLogoGmail].map((Icon, index) => (
                  <motion.a
                    key={index}
                    href="mailto:nikhs323@gmail.com"
        ...
        >
          ...
          <p className='text-[#71717A] text-sm/6 lg:text-base mt-3 lg:mt-6'>Have a UI/UX, web design or visual-design opportunity? I’d love to hear about it.</p>
